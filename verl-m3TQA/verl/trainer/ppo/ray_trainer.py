...
class RayPPOTrainer:
    ...
    def _dump_generations(self, inputs, outputs, scores, reward_extra_infos_dict, dump_path, ground_truth=None):
    ...
    def _validate(self):
        ...
        for test_data in self.val_dataloader:
            ...
            reward_info = test_batch.non_tensor_batch["reward_model"]
            # TODO: Can we keep special tokens except for padding tokens?
            input_texts = [self.tokenizer.decode(ids, skip_special_tokens=True) for ids in input_ids]
            ground_truth_info = [rw['ground_truth'] for rw in reward_info]
            sample_inputs.extend(input_texts)
            sample_ground_truth.extend(ground_truth_info)
